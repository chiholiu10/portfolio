...
const DynamicIntroduction = dynamic(() =>
  import('../components/Sections/Introduction/Introduction').then((mod) => mod.Introduction)
)

const DynamicExperience = dynamic(() =>
  import('../components/Sections/Experience/Experience').then((mod) => mod.Experience)
)

const DynamicPortfolio = dynamic(() =>
  import('../components/Sections/Portfolio/Portfolio').then((mod) => mod.Portfolio)
)
